...
const DEFAULT_RECTANGLE_SIZE = [0.06, 0.2]; //width, height 12/43, 30/43
...
function generateStimulus(featureData, factorData) {
    ...
    const firstFactor = document.getElementById("locatability");
    ...
    let stimulusTop = firstFactorRect.bottom;
